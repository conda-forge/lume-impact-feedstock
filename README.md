...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8890&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lume-impact-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
mamba repoquery search lume-impact --channel conda-forge

# List packages depending on `lume-impact`:
mamba repoquery whoneeds lume-impact --channel conda-forge
...
Updating lume-impact-feedstock
==============================

If you would like to improve the lume-impact recipe or build a new
...
Note that all branches in the conda-forge/lume-impact-feedstock are
